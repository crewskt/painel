...
Vue.component("linechart", {
   props: {
      width: { type: Number, default: 50, required: true },
...
new Vue({
   ...
   data: {
      ...
      sort: "volatility",//"assetVolume", // sort by param
   ...
   methods: {
      ...
      getCoinData(item) {
         ...
         if (percent > 2) style = "gain";
         if (percent < -2) style = "loss";
